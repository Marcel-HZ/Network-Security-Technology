...
// 按位取值或赋值
const unsigned int pc_by_bit[64] = {
...
// 密钥循环左移
const int leftTable[16] = { 1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1 };

// 密钥选取
const int keyChoose[48] = {
